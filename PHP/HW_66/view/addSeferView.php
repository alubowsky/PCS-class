...
?>
        <form class="form-horizontal" method = "POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" id="catagory" name = "catagory" placeholder="catagory" required>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class=" row col-sm-offset-5 col-sm-2 text-center">
            <a href="index.php" class= "btn btn-info">To look for seforim Click Here!</a>
        </div>

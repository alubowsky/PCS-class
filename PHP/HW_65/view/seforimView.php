...
?>
    <form class="form-horizontal">
        ...
        <div class="col-sm-offset-2 col-sm-2 text-center">
            <a href="addSeferController.php" class= "btn btn-info">To sell your seforim Click Here!</a>
        </div>
        <div class="col-sm-offset-2 col-sm-2 text-center">
            <a href="deleteSeferController.php" class= "btn btn-info">To remove a sefer click here</a>
        </div>
        </div>
<?php 
    include "bottom.php";
